...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.turn_label.setGeometry(QtCore.QRect(340, 660, 191, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.turn_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.turn_label_2.setGeometry(QtCore.QRect(810, 660, 501, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.turn_label_2.sizePolicy().hasHeightForWidth())
        self.turn_label_2.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(16)
        font.setBold(False)
        ...
        font.setStrikeOut(False)
        font.setKerning(True)
        self.turn_label_2.setFont(font)
        self.turn_label_2.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.turn_label_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.turn_label_2.setText("")
        self.turn_label_2.setTextFormat(QtCore.Qt.PlainText)
        self.turn_label_2.setScaledContents(True)
        self.turn_label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.turn_label_2.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse)
        self.turn_label_2.setObjectName("turn_label_2")
