...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.game_start_button.setGeometry(QtCore.QRect(540, 590, 200, 50))
        ...
        self.game_start_button.setObjectName("pushButton")
        self.widget_5 = QtWidgets.QWidget(self.centralwidget)
        self.widget_5.setGeometry(QtCore.QRect(670, 240, 421, 271))
        self.widget_5.setObjectName("widget_5")
        self.widget_6 = QtWidgets.QWidget(self.widget_5)
        self.widget_6.setGeometry(QtCore.QRect(0, 0, 271, 121))
        ...
        self.second_player_hotseat_rb.setObjectName("radioButton")
        ...
        self.second_player_bot_rb.setObjectName("radioButton_2")
        self.widget_4 = QtWidgets.QWidget(self.widget_5)
        self.widget_4.setGeometry(QtCore.QRect(0, 120, 411, 161))
        ...
        self.radioButton_5.setGeometry(QtCore.QRect(10, 80, 91, 30))
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(13)
        ...
        self.radioButton_6.setGeometry(QtCore.QRect(10, 50, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(13)
        ...
        self.bot_game_difficult_easy_rb.setGeometry(QtCore.QRect(20, 80, 91, 30))
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(13)
        self.bot_game_difficult_easy_rb.setFont(font)
        self.bot_game_difficult_easy_rb.setChecked(False)
        self.bot_game_difficult_easy_rb.setObjectName("radioButton_3")
        self.bot_game_difficult_hard_rb = QtWidgets.QRadioButton(self.widget_2)
        self.bot_game_difficult_hard_rb.setGeometry(QtCore.QRect(20, 50, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Georgia")
        font.setPointSize(13)
        self.bot_game_difficult_hard_rb.setFont(font)
        self.bot_game_difficult_hard_rb.setChecked(True)
        self.bot_game_difficult_hard_rb.setObjectName("radioButton_4")
        ...
        self.widget_11.setGeometry(QtCore.QRect(270, 240, 401, 271))
        ...
        self.mines_count.setObjectName("lineEdit_4")
        ...
        self.ships_len = QtWidgets.QLineEdit(self.widget_11)
        self.ships_len.setGeometry(QtCore.QRect(10, 110, 341, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.ships_len.setFont(font)
        self.ships_len.setMaxLength(42)
        self.ships_len.setObjectName("lineEdit_3")
        ...
        self.game_field_height.setObjectName("lineEdit_2")
        ...
        self.game_field_width.setObjectName("lineEdit")
        ...
        self.minesweepers_count.setObjectName("lineEdit_5")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(520, 160, 251, 41))
        ...
        self.label.setGeometry(QtCore.QRect(420, 0, 445, 104))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_5.setText(_translate("MainWindow", "200 iq"))
        self.radioButton_6.setText(_translate("MainWindow", "рандом"))
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p>расстановка кораблей</p></body></html>"))
        self.bot_game_difficult_easy_rb.setText(_translate("MainWindow", "200 iq"))
        self.bot_game_difficult_hard_rb.setText(_translate("MainWindow", "рандом"))
        ...
        self.ships_len.setText(_translate("MainWindow", "4 3 3 2 2 2 1 1 1 1"))
